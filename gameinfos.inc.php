...
'game_name' => "Say Anything",

// Game designer (or game designers, separated by commas)
'designer' => 'Satish Pillalamarri, Dominic Crapuchettes',       

// Game artist (or game artists, separated by commas)
'artist' => 'Kelly Cooper Kwoka, Ali Douglas, Jacoby O\'Connor',         
...
'presentation' => array(
    totranslate("Winner of over 30 awards, Say Anything is a freewheeling game with questions and answers about what you and your friends think."),
    totranslate("Each round, players answer a question like \"What would make next weekend more exciting?\" or \"When's the worst time to burst out laughing?\" After the answers are revealed, the judge secretly picks their favorite answer and everyone else tries to guess which one the judge picked."),
    totranslate("Say Anything is simple, fast-paced, witty, and great fun with any group of friends!")
),
